...
var Index = function Index(_ref) {
  ...
  }), _api_news_json__WEBPACK_IMPORTED_MODULE_6__.map(function (post, position) {
  ...
  }, "Telegram \u0431\u043E\u0442: @KEPBetabot"), __jsx("a", {
...
var textP = "Запускаю першу альфу, щоб показати вам своє бачення сайту та розуміти як далі розвивати його. Зібрав на мою думку саму важливу інформацію та постарався її подати максимально зручно, звичайно він не ідеальний";
console.log(textP.length); // Index.getInitialProps = async ctx => {
...
//# sourceMappingURL=index.js.61182bbb3a32272ec212.hot-update.js.map